...
Future<ResponseExerciseScoresStruct?> actionWeightsFunctionalScore(
    double weightLifted,
    String weightUnit,
    int repetitions,
    int setCount,
    ...
    List<MusclesAppStateStruct> muscles) async {
  double totalScore = 0;
  ...
  double difficultyMultiplier = exerciseDoc.difficultyMultiplier.toDouble();
