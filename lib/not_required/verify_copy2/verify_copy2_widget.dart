...
import 'verify_copy2_model.dart';
export 'verify_copy2_model.dart';

class VerifyCopy2Widget extends StatefulWidget {
  const VerifyCopy2Widget({
    super.key,
  ...
  @override
  State<VerifyCopy2Widget> createState() => _VerifyCopy2WidgetState();
}

class _VerifyCopy2WidgetState extends State<VerifyCopy2Widget>
    with TickerProviderStateMixin {
  late VerifyCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerifyCopy2Model());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'VerifyCopy2'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('VERIFY_COPY2_VerifyCopy2_ON_INIT_STATE');
      logFirebaseEvent('VerifyCopy2_timer');
              ...
              children: [
                Align(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'VERIFY_COPY2_PAGE_Icon_e37q71xw_ON_TAP');
                        ...
                        children: [
                          Align(
                            ...
                            child: PinCodeTextField(
                              ...
                              onChanged: (_) async {
                                logFirebaseEvent(
                                    'VERIFY_COPY2_otpTextbox_ON_TEXTFIELD_CHA');
                                logFirebaseEvent('otpTextbox_custom_action');
                                await actions.otpInputValidation();
                              },
                              onCompleted: (_) async {
                                logFirebaseEvent(
                                    'VERIFY_COPY2_otpTextbox_ON_PINCODE_COMPL');
                                logFirebaseEvent('otpTextbox_validate_form');
                                if (_model.formKey.currentState == null ||
                                    !_model.formKey.currentState!.validate()) {
                                  return;
                                }
                                // Verify the sms
                                logFirebaseEvent('otpTextbox_Verifythesms');
                                ...
                                // Get Muscles Data
                                logFirebaseEvent('otpTextbox_GetMusclesData');
                                _model.newAutoMusclesQueryResponse =
                                    await queryMusclesRecordOnce();
                                // Update muscles data in app state
                                logFirebaseEvent(
                                    'otpTextbox_Updatemusclesdatainappstate');
                                FFAppState().musclesData = functions
                                    .convertMuscleDocToJson(_model
                                        .newAutoMusclesQueryResponse
                                        ?.toList())!
                                    .toList()
                                ...
                                logFirebaseEvent(
                                    'otpTextbox_Readtheuserdatadoc');
                                _model.userAuthDataResponse =
                                ...
                                if (_model.userAuthDataResponse != null) {
                                  if (_model.userDataResponse?.type ==
                                      'trainer') {
                                    // update user type
                                    logFirebaseEvent(
                                        'otpTextbox_updateusertype');
                                    FFAppState().userType =
                                    ...
                                    logFirebaseEvent(
                                        'otpTextbox_UpdateUserdatarefinappstate');
                                    FFAppState().userDataReference =
                                        _model.userDataResponse?.reference;
                                    safeSetState(() {});
                                    logFirebaseEvent('otpTextbox_navigate_to');
                                  ...
                                  logFirebaseEvent(
                                      'otpTextbox_GetMobileUserData');
                                  _model.oldUserDataResponseCopy =
                                      await queryUsersDataRecordOnce(
                                    queryBuilder: (usersDataRecord) =>
                                        usersDataRecord.where(
                                      'phone_number',
                                  ...
                                  if (_model.oldUserDataResponse != null) {
                                    ...
                                    logFirebaseEvent(
                                        'otpTextbox_UpdateUserrefvalueformobile');

                                    await _model.oldUserDataResponse!.reference
                                    ...
                                    if (_model.oldUserDataResponse?.type ==
                                      ...
                                      logFirebaseEvent(
                                          'otpTextbox_UpdateUserdatarefinappstate');
                                      FFAppState().userDataReference =
                                          _model.oldUserDataResponse?.reference;
                                      safeSetState(() {});
                                      logFirebaseEvent(
                                          'otpTextbox_navigate_to');
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                FlutterFlowTimer(
                                  ...
                                  onEnded: () async {
                                    logFirebaseEvent(
                                        'VERIFY_COPY2_resendTimer_ON_TIMER_END');
                                    logFirebaseEvent(
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'VERIFY_COPY2_PAGE_SUBMIT_BTN_ON_TAP');
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'VERIFY_COPY2_PAGE_Text_9lw3ik53_ON_TAP');
