...
import 'strongman_exercise_model.dart';
export 'strongman_exercise_model.dart';

class StrongmanExerciseWidget extends StatefulWidget {
  const StrongmanExerciseWidget({
    super.key,
    ...
    String? weightUnit,
  })  : distanceCovered = distanceCovered ?? 5,
        sets = sets ?? 1,
  ...
  @override
  State<StrongmanExerciseWidget> createState() =>
      _StrongmanExerciseWidgetState();
}

class _StrongmanExerciseWidgetState extends State<StrongmanExerciseWidget> {
  late StrongmanExerciseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StrongmanExerciseModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'StrongmanExercise'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('STRONGMAN_EXERCISE_StrongmanExercise_ON_');
      logFirebaseEvent('StrongmanExercise_update_page_state');
    ...
    _model.additionalWeighTxtValFocusNode!.addListener(
      () async {
        logFirebaseEvent('STRONGMAN_EXERCISE_additionalWeighTxtVal');
    ...
    _model.distanceCoveredTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.distanceCovered.toString(),
      '0',
    ));
    _model.distanceCoveredFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ExercisesRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final strongmanExerciseExercisesRecord = snapshot.data!;
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'STRONGMAN_EXERCISE_Icon_r2ovbmpm_ON_TAP');
                        ...
                        child: Column(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'STRONGMAN_EXERCISE_Container_l5s4k2mp_ON');
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: Image.network(
                                        functions.getImageUrl(
                                            strongmanExerciseExercisesRecord
                                                .code,
                                    ...
                                    Text(
                                      strongmanExerciseExercisesRecord.name,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Manrope',
                                        ...
                                        Padding(
                                          ...
                                          child: FlutterFlowRadioButton(
                                            ...
                                            onChanged: (val) async {
                                              safeSetState(() {});
                                              logFirebaseEvent(
                                                  'STRONGMAN_EXERCISE_weightUnitBtn_ON_FORM');
                                              logFirebaseEvent(
                                      ...
                                      children: [
                                        Expanded(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'STRONGMAN_EXERCISE_Container_3y81jrp4_ON');
                                              logFirebaseEvent(
                                        ...
                                        Expanded(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'STRONGMAN_EXERCISE_Container_f7mgcfy7_ON');
                                              logFirebaseEvent(
                                                  'Container_set_form_field');
                                              safeSetState(() {
                                                _model
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'STRONGMAN_EXERCISE_Container_n879lajk_ON');
                                            logFirebaseEvent(
                                                'Container_set_form_field');
                                            safeSetState(() {
                                              _model
                                                  .distanceCoveredTextController
                                                  ?.text = (int.parse(_model
                                                          .distanceCoveredTextController
                                                          .text) +
                                                      10)
                                                  .toString();
                                              _model.distanceCoveredFocusNode
                                                  ?.requestFocus();
                                              WidgetsBinding.instance
                                                  .addPostFrameCallback((_) {
                                                _model.distanceCoveredTextController
                                                        ?.selection =
                                                    TextSelection.collapsed(
                                                  offset: _model
                                                      .distanceCoveredTextController!
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'STRONGMAN_EXERCISE_Container_d8sfpeoc_ON');
                                            logFirebaseEvent(
                                                'Container_set_form_field');
                                            safeSetState(() {
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'STRONGMAN_EXERCISE_Container_stbvsf3h_ON');
                                              logFirebaseEvent(
                                                  'Container_set_form_field');
                                              safeSetState(() {
                                                _model
                                          ...
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'STRONGMAN_EXERCISE_Container_0ehq03le_ON');
                                              logFirebaseEvent(
                                                  'Container_set_form_field');
                                              safeSetState(() {
                                                _model.setTxtValTextController
                                      ...
                                      builder: (context) {
                                        if (widget.oldExerciseScore != null) {
                                          return FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'STRONGMAN_EXERCISE_UpdateButton_ON_TAP');
                                              ...
                                              try {
                                                ...
                                                _model.updateActionCalculateStrongmanScoreResponse =
                                                    await actions
                                                        .actionCalculateStrongmanScore(
                                                  _model.updateUserDataResponse!
                                                      .weight,
                                                  _model.weightUnit,
                                                  double.parse(_model
                                                ...
                                                if (_model
                                                        .updateActionCalculateStrongmanScoreResponse
                                                        ?.totalScore ==
                                                    0.0) {
                                                  logFirebaseEvent(
                                          ...
                                          return FFButtonWidget(
                                            onPressed: () async {
                                              logFirebaseEvent(
                                                  'STRONGMAN_EXERCISE_PAGE_ADD_BTN_ON_TAP');
                                              // Get user data
                                              logFirebaseEvent(
                                                  'Button_Getuserdata');
                                              ...
                                              _model.actionCalculateStrongmanScoreResponse =
                                                  await actions
                                                      .actionCalculateStrongmanScore(
                                              ...
                                              if (_model
                                                      .actionCalculateStrongmanScoreResponse
                                                      ?.totalScore ==
                                                  0.0) {
                                                logFirebaseEvent(
