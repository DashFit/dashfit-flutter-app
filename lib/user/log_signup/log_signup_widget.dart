...
import 'log_signup_model.dart';
export 'log_signup_model.dart';

class LogSignupWidget extends StatefulWidget {
  const LogSignupWidget({super.key});

  @override
  State<LogSignupWidget> createState() => _LogSignupWidgetState();
}

class _LogSignupWidgetState extends State<LogSignupWidget> {
  late LogSignupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LogSignupModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'LogSignup'});
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: Align(
            ...
            child: Padding(
              padding: const EdgeInsetsDirectional.fromSTEB(25.0, 45.0, 25.0, 0.0),
              child: Column(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'LOG_SIGNUP_PAGE_SendOtpButton_ON_TAP');
                              logFirebaseEvent('SendOtpButton_validate_form');
                              if (_model.formKey.currentState == null ||
                                  !_model.formKey.currentState!.validate()) {
                                return;
                              }
                              // generate OTP
                              logFirebaseEvent('SendOtpButton_generateOTP');
                              _model.otpValue = await actions.generateOtp(
                                _model.phoneNumberTextController.text,
                              );
                              // Send SMS
                              logFirebaseEvent('SendOtpButton_SendSMS');
                              ...
                              if ((_model.apiSendSms?.statusCode ?? 200)
                                      .toString() ==
                                  '200') {
                                logFirebaseEvent(
                                    'SendOtpButton_firestore_query');
                                ...
                                if (_model.mobileNumberOtpExists != null) {
                                  logFirebaseEvent(
                                      'SendOtpButton_backend_call');

                                  await _model.mobileNumberOtpExists!.reference
                                ...
                                logFirebaseEvent('SendOtpButton_navigate_to');
                            ...
                            options: FFButtonOptions(
                              ...
                              borderRadius: BorderRadius.circular(8.0),
                              hoverColor: const Color(0xFF74B87B),
                            ),
                          ),
                        ),
